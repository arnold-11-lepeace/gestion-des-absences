...
public class EleveDao extends ConnectionDAO{
	...
	public int add(Eleve eleve) {
		 ...
		 ps = con.prepareStatement("INSERT INTO ETUDIANT VALUES (?, ?, ?,?,?,?)");
	...
	public ArrayList<Eleve> getList(){
		...
		public static void main(String[] args) throws SQLException {
			...
			Eleve E1 = new Eleve(ids[0],"azerty","ONANA", "Arnold", 
					"peace@gmail.com","apprentie");
			Eleve E2 = new Eleve(ids[1],"StringEleve","NYA", "Serena", 
					"NYA@gmail.com","apprentie");
			Eleve E3 = new Eleve(ids[2],"StringEleve","OTA", "Simon", 
					"OTA@gmail.com","apprentie");
