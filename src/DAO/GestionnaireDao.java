...
public class GestionnaireDao extends ConnectionDAO {
	...
	/*
	 * permet de comparer les identifiants entrées par l'utilisateur à ceux présents dans la base de données
	 * @param id, password
	 */
	public Gestionnaire loginGestionnaire(int identifiant, String motDePasse) {
		 ...
		 ps = con.prepareStatement("SELECT * FROM GESTIONNAIRE WHERE IDGESTIONNAIRE=? AND MOTDEPASSEGESTIONNAIRE= ?");
